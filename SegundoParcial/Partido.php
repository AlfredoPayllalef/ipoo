...
public function __toString(){
    ...
    //darEquipoGanador() retorna el ganador o los dos
    public function darEquipoGanador(){
        $golE1=$this->getCantGolesE1();
        $golE2=$this->getCantGolesE2();
        $ganador=[];
        if ($golE1==$golE2) {
            $ganador[0]=$this->getObjEquipo1();
            $ganador[1]=$this->getObjEquipo2();
        }
        if ($golE1>$golE2) {
            $ganador[0]=$this->getObjEquipo1();
        }
        else {
            $ganador[0]=$this->getObjEquipo2();
        }
        return $ganador;
    }
    /*
